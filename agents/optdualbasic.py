...
class OptDualAgent:
    def __init__(self,
        ...
        self.lambda_1 = 0 # initializing lambda_1 to 0
        self.t_lambda = sqrt((self.episodes+1)) # initializing t_lambda
        ...
        self.planner = OptimisticLinearProgrammingPlanner(
            ...
            self.env, self.max_reward, self.min_reward, self.max_cost, self.min_cost, self.episodes,self.t_lambda,
    ...
    @classmethod
    def from_discrete_env(cls, env: DiscreteEnv, **kwargs) -> 'RandomAgent':
    ...
    def act(self, state):
        ...
        return self.rng.choice(range(self.na), size=1)[0]
